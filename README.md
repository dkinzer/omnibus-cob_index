...
```shell
$ bin/omnibus clean cob_index
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/cob_index`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean cob_index --purge
```
...
[vagrant@ubuntu...] $ cd cob_index
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build cob_index
```
